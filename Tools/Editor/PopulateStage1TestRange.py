...
def spawn_cube(name: str, location: unreal.Vector, scale: unreal.Vector) -> unreal.Actor:
...
spawn_cube("BO_TestRange_Floor", unreal.Vector(900, 0, -60), unreal.Vector(20, 12, 0.2))
spawn_cube("BO_TestRange_Backstop", unreal.Vector(2200, 0, 220), unreal.Vector(0.25, 8, 3.0))
spawn_cube("BO_TestRange_LeftWall", unreal.Vector(900, -650, 160), unreal.Vector(20, 0.2, 2.2))
spawn_cube("BO_TestRange_RightWall", unreal.Vector(900, 650, 160), unreal.Vector(20, 0.2, 2.2))
